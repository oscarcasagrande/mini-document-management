    ...
    : IDocumentOcrProvider
{
        ...
        CancellationToken ct)
    {
        ...
        for (var pageNumber = 1; pageNumber <= document.PageCount; pageNumber++)
        {
            ...
            var analysis = await AnalyzePageAsync(document, pageNumber, options, ct).ConfigureAwait(false);
        ...
        CancellationToken ct)
    {
        ...
        try
        {
            ...
            file.Headers.ContentType = new MediaTypeHeaderValue(document.MimeType);
